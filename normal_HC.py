...
def calc_full_h(board,curr_h):
    heuristic_board=[[1000 for x in range(0,len(board))] for y in range(0,len(board))]
    for x in range(0,len(board)):
        for y in range(0,len(board)):
            if(board[x][y]>0):
                queen_row = x
                ...
                while(succ_row>0):
                    ...
                    succ_h_value = calc_h(2,succ_attack_pairs)
...
while(run_heuristic):
    ...
    #print(attack_pair)
    current_heuristic = calc_h(2, attack_pair)
...
print("final board")
print_board(current_board)
print(find_no_of_attacking_queens(current_board))
print("total cost",total_move_cost)
